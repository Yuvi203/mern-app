...
const Explore = ({users, Setusers, loading, setLoading, show, Setshow}) => {
  ...
  const getdesigners = async () =>{
    await axios.get(`http://localhost:8000/api/getdesigners/${id}`).then((res)=>{
      Setusers(res.data)
 ...
 const getdatascientist = async () =>{
  await axios.get(`http://localhost:8000/api/getdatascientist/${id}`).then((res)=>{
    Setusers(res.data)
    console.log("designers", res.data)
    setLoading(false)
  })
...
const getbusinessanalyst = async () =>{
  await axios.get(`http://localhost:8000/api/getbusinessanalyst/${id}`).then((res)=>{
    Setusers(res.data)
    console.log("designers", res.data)
    setLoading(false)
  })
...
const getaiandml = async () =>{
  await axios.get(`http://localhost:8000/api/getaiandml/${id}`).then((res)=>{
    Setusers(res.data)
    console.log("designers", res.data)
    setLoading(false)
  })
...
const getblockchain = async () =>{
  await axios.get(`http://localhost:8000/api/getblockchain/${id}`).then((res)=>{
    Setusers(res.data)
    console.log("designers", res.data)
    setLoading(false)
  })
...
const getdevops = async () =>{
  await axios.get(`http://localhost:8000/api/getdevops/${id}`).then((res)=>{
    Setusers(res.data)
    console.log("designers", res.data)
    setLoading(false)
  })
...
const getcloud = async () =>{
  await axios.get(`http://localhost:8000/api/getcloud/${id}`).then((res)=>{
    Setusers(res.data)
    console.log("designers", res.data)
    setLoading(false)
  })
